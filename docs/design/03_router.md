...
![NI / Router Block Diagram](../images/ni_router_block.svg)
...
**描述：** Router 每 cycle 執行 8-phase pipeline（完整定義見 [Simulation Platform](09_simulation.md) §6）。Phase 1~4 封裝在 `tick()` 內，Phase 6~7 為 post-wire 處理。
...
- [Multicast](08_multicast.md) — RCR routing algorithm
- [Simulation](09_simulation.md) — 8-phase cycle model、NocConfig、Channel\<T\>
