...
│   │  C++ Router ↔ Router DPI Bridge  |  C++ NI ↔ NI DPI Bridge       │   │
│   └─────────────────────────────────────────────────────────────┘   │
└────────────────────────────┬────────────────────────────────────────┘
                             ↓ DPI-C
┌─────────────────────────────────────────────────────────────────────┐
...
```
┌──────────────┐                           ┌──────────────┐
│  C++ Router   │── Router_Interface<M> ──│Router DPI Bridge│
│  (C++ Model) │                           │  (DPI-C)     │
└──────────────┘                           └──────────────┘
         ▲           Simulation Driver           ▲
         │           (Mesh wiring loop)          │
         ▼                                       ▼
┌──────────────┐                           ┌──────────────┐
│  C++ NI       │── NI_Interface<M> ──────│  NI DPI Bridge  │
│  (C++ Model) │                           │  (DPI-C)     │
└──────────────┘                           └──────────────┘
```
...
|-------------------|--------|----|----------|
| Pure C++ | C++ Router | C++ NI | 高速效能模擬 |
| NI RTL | C++ Router | NI DPI Bridge | NI RTL 驗證 |
| Router RTL | Router DPI Bridge | C++ NI | Router RTL 驗證 |
...
| Scoreboard / Metrics Collector | 驗證（online per-txn tracking）與統計邏輯，C++ only |
...
- [Router](03_router.md) — 8-phase pipeline、C++ Router pipeline stages
- [Network Interface](04_network_interface.md) — NMU/NSU、C++ NI functions
