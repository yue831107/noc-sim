...
Each router consists of two structurally symmetric Req Router / Rsp Router: a ReqRouter for AW/W/AR flits and a RspRouter for B/R flits. The RspRouter additionally includes in-network reduction logic for multicast B response merging.
