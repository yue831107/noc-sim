...
|------|-----------|-------|
| Valid/Ready (No-VC) | [55:50] + [49:32] | 24 |
| Credit-Based (With-VC) | [55:53] + [49:32] | 21 |
...
```
 55              32 31    27  26   25  24 23 22    15 14     7  6  4  3  0
┌─────────────────┬──────┬────┬────┬─────┬────────┬────────┬─────┬──────┐
│      rsvd       │ rob  │rob │last│port │ dst_id │ src_id │ axi │ qos  │
│      24b        │idx 5b│req │ 1b │id 2b│   8b   │   8b   │ch 3b│  4b  │
│                 │      │ 1b │    │     │        │        │     │      │
└─────────────────┴──────┴────┴────┴─────┴────────┴────────┴─────┴──────┘
```
...
```
 55 53 52 50 49              32 31    27  26   25  24 23 22    15 14     7  6  4  3  0
┌────┬────┬─────────────────┬──────┬────┬────┬─────┬────────┬────────┬─────┬──────┐
│rsvd│ vc │      rsvd       │ rob  │rob │last│port │ dst_id │ src_id │ axi │ qos  │
│ 3b │id 3b│      18b       │idx 5b│req │ 1b │id 2b│   8b   │   8b   │ch 3b│  4b  │
│    │    │                 │      │ 1b │    │     │        │        │     │      │
└────┴────┴─────────────────┴──────┴────┴────┴─────┴────────┴────────┴─────┴──────┘
```
...
- [Router Specification](03_router.md) — 408-bit flit 轉發與 pipeline
