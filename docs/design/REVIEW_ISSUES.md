...
**檔案**: `11_simulation.md` Section 1.1 + `05_internal_interface.md` Section 3
...
**檔案**: `05_internal_interface.md` Section 7.2 + `11_simulation.md` Section 8.3
...
**檔案**: `11_simulation.md` Section 2.7
...
**檔案**: `11_simulation.md` Section 6.1
...
**檔案**: `11_simulation.md` Section 1.1
...
**檔案**: `11_simulation.md` Section 5.1

### MR-5: TxnStatus 缺少 TIMEOUT state
**檔案**: `11_simulation.md` Section 4.1

### MR-6: NSU reassembly buffer 硬編碼 16，應與 max_burst_len 連動
**檔案**: `04_network_interface.md` Section 5.6

### MR-7: max_outstanding 三個文件不同預設值 (8/16/32) — 需釐清是否為不同參數
**檔案**: `11_simulation.md`, `04_network_interface.md`, `12_parameters_guide.md`

### MR-8: 缺少 memory access latency model
**檔案**: `08_memory_operations.md` + `11_simulation.md` Section 6.3
...
### MR-11: 13_golden_verification.md + 14_metrics.md 的 Python code 需改為 C++
**檔案**: `13_golden_verification.md`, `14_metrics.md`

### MR-12: 15_verification_strategy.md 缺少 multicast deadlock test 和 reset behavior test
**檔案**: `15_verification_strategy.md`

### MR-13: Width Converter 不在 verification plan 中
**檔案**: `15_verification_strategy.md` + `09_width_converter.md`
